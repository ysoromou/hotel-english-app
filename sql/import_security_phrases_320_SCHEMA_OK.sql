...
insert into phrases (id, action_id, phrase_fr, phrase_en, phase, niveau, voice_type, audio_url)
...
insert into phrases (id, action_id, phrase_fr, phrase_en, phase, niveau, voice_type, audio_url)
values ('SEC_ID_VERIFICATION_03', 'SEC_ID_VERIFICATION', 'C’est une procédure STAFF pour protéger les clients et les chambres.', 'It is a STAFF procedure to protect guests and rooms.', 'CLARIFY', 'A2', 'STAFF', null)
on conflict (id) do update set
  action_id = excluded.action_id,
  phrase_fr = excluded.phrase_fr,
  phrase_en = excluded.phrase_en,
