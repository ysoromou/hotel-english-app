begin;
-- 12 scénarios multi-problèmes (Réception 4 étoiles) — v2 (apostrophes nettoyées + policy minibar/amount)
...
STAFF: To help you leave on time, I can temporarily remove the minibar charge of {amount} {currency} pending verification, within our front-desk authorization. If it exceeds our desk limit, I will immediately call the manager for approval. I will follow up today.
